...
import com.giroux.kevin.forecastapplication.FetchWeatherTask;
...
public class TestFetchWeatherTask extends AndroidTestCase{
    ...
    public void testAddLocation() {
        ...
        AndroidHttpRequest androidHttpRequest = new AndroidHttpRequest("test",null,null);
        androidHttpRequest.setmContext(getContext());

        long locationId = androidHttpRequest.addLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
        ...
        for ( int i = 0; i < 2; i++ ) {
            ...
            Cursor locationCursor = getContext().getContentResolver().query(
                    ...
                    new String[]{
                            ...
                            WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING,
                            WeatherContract.LocationEntry.COLUMN_LOCATION_CITY_NAME,
            ...
            long newLocationId = androidHttpRequest.addLocation(ADD_LOCATION_SETTING, ADD_LOCATION_CITY,
                    ADD_LOCATION_LAT, ADD_LOCATION_LON);
